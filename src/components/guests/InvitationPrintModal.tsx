        ...
        <div className="mt-6 sm:mt-8 flex justify-between items-end">
          ...
          <div className="text-center flex flex-col items-center">
            ...
            <div className="h-16 sm:h-20 flex items-center justify-center my-0 relative">
              <img src="/stempel.png" alt="Stempel" className="absolute left-1/2 -translate-x-[100%] top-1/2 -translate-y-1/2 h-40 w-40 sm:h-48 sm:w-48 max-w-none object-contain mix-blend-multiply opacity-80 z-0" onError={(e) => e.currentTarget.style.display = 'none'} />
